...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductTable = React.createClass({displayName: "ProductTable",
	    render: function() {
	        ...
	        var name = this.props.filterText;        
	        name = (name.length > 1) ? name.replaceAt(1, "○") : name;
	        
	        this.props.products.forEach(function(product) {
	            if (product.id.indexOf(this.props.filterText) === -1
	                && product.city.indexOf(this.props.filterText) === -1
	                && product.unit.indexOf(this.props.filterText) === -1
	                && product.name.indexOf(name) === -1
	                && product.gender.indexOf(this.props.filterText) === -1
	                && product.country.indexOf(this.props.filterText) === -1
	                && product.age.toString().indexOf(this.props.filterText) === -1
	                && product.oth1.indexOf(this.props.filterText) === -1
	                && product.oth2.indexOf(this.props.filterText) === -1
	                && product.oth3.indexOf(this.props.filterText) === -1
	                && product.oth4.indexOf(this.props.filterText) === -1
	            ...
	            if (product.age.toString().indexOf(this.props.filterText) !== -1 && this.props.filterText != '') match = "age";
	        ...
	        return (
	            React.createElement("table", null, 
	                ...
	                React.createElement("tbody", {style: style.td}, rows)
	            )
	        );
	    }
	});
	    ...
	    render: function() {
	        return (
	            React.createElement("div", null, 
	                ...
	                React.createElement("div", {style: style.sub}, "最後更新時間：", this.props.lastmodify), 
	                React.createElement("div", {style: style.sub}, "資料來源：", this.props.source), 
	...
	React.render(React.createElement(FilterableProductTable, {products: data.Member, source: data.source, lastmodify: data.lastmodify, info: Info}), document.body);
